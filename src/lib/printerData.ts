...
export type PrinterCategory = 'mbo' | 'artisjet' | 'mbo-granformato' | 'pimpam' | 'discontinued';
...
export const printerModels: PrinterModel[] = [
  // ============ MBO PRINTERS ============
  {
    ...
    specs: {
      ...
      maxHeight: '10 cm',
      resolution: '720 x 1440 / 720 x 2160 dpi',
    ...
    manualUrl: 'https://mboprinters.com/product/mbo-3050-uv-led',
  ...
  },
  {
    ...
    manualUrl: 'https://mboprinters.com/product/mbo-4060-uv-led',
    consumables: mboConsumablesTx800,
    accessories: mboAccessories,
  },
  {
  ...
  },
  {
    ...
    manualUrl: 'https://mboprinters.com/product/mbo-6090-uv-led',
    consumables: mboConsumablesTx800,
    accessories: [...mboAccessories, {
  ...
  },
  {
    ...
    specs: {
      ...
      maxHeight: '10 cm',
      resolution: '1200 x 1800 dpi',
      inkType: 'UV LED CMYK + WWWW + Barniz',
      heads: '4',
      headType: 'I3200',
      connectivity: 'USB 2.0',
      power: '220V AC 50/60Hz',
    ...
    manualUrl: 'https://mboprinters.com/en/product/mbo-1015-uv-led',
    consumables: mboConsumablesI3200,
    accessories: [...mboAccessories, {
      id: 'rotary-integrated',
      name: 'Dispositivo Rotativo Integrado',
  ...
  // ============ MBO GRAN FORMATO ============
  {
    ...
    brand: 'MBO PRINTERS',
    name: 'MBO UV1612G',
    fullName: 'MBO UV1612G Gran Formato',
    category: 'mbo-granformato',
    image: 'https://mboprinters.com/wp-content/uploads/2024/11/mbo1612g.jpg',
    price: '26.500€',
    priceWithVat: '32.065€',
    specs: {
      printArea: '160 x 120 cm',
      maxHeight: '15 cm',
      resolution: '720 x 1440 dpi',
      inkType: 'UV LED CMYK + W + Barniz',
      heads: '3',
      headType: 'Epson I3200',
      connectivity: 'USB 2.0 / Ethernet',
      power: '220V AC 50/60Hz',
      dimensions: '280 x 200 x 130 cm',
      weight: '600 kg',
    },
    manualUrl: 'https://mboprinters.com/en/product/mbo-uv1612g',
    consumables: mboConsumablesI3200,
    accessories: [...mboAccessories, {
      id: 'vacuum-industrial',
      name: 'Mesa de Vacío Industrial',
  ...
  },
  {
    ...
    brand: 'MBO PRINTERS',
    name: 'MBO UV1812',
    fullName: 'MBO UV1812 Gran Formato',
    category: 'mbo-granformato',
    image: 'https://mboprinters.com/wp-content/uploads/2024/11/mbo1812.jpg',
    price: '27.500€',
    priceWithVat: '33.275€',
    specs: {
      printArea: '180 x 120 cm',
      maxHeight: '15 cm',
      resolution: '720 x 1440 dpi',
      inkType: 'UV LED CMYK + W + Barniz',
      heads: '3',
      ...
      connectivity: 'USB 2.0 / Ethernet',
      power: '220V AC 50/60Hz',
      dimensions: '300 x 200 x 130 cm',
      weight: '700 kg',
    },
    manualUrl: 'https://mboprinters.com/en/product/mbo-uv1812',
    consumables: mboConsumablesI3200,
    accessories: [...mboAccessories, {
      id: 'vacuum-industrial',
      name: 'Mesa de Vacío Industrial',
  ...
  },
  {
    ...
    brand: 'MBO PRINTERS',
    name: 'MBO UV2513',
    fullName: 'MBO UV2513 Gran Formato Industrial',
    category: 'mbo-granformato',
    image: 'https://mboprinters.com/wp-content/uploads/2024/11/mbo2513.jpg',
    price: '34.000€',
    priceWithVat: '41.140€',
    specs: {
      printArea: '250 x 125 cm',
      maxHeight: '15 cm',
      resolution: '720 x 1440 dpi',
      inkType: 'UV LED CMYK + LC + LM + W + Barniz',
      heads: '3',
      headType: '3x Epson I3200 Industrial',
      connectivity: 'USB 2.0 / Ethernet',
      power: '220V AC 50/60Hz',
      dimensions: '340 x 170 x 130 cm',
      weight: '1000 kg',
    },
    manualUrl: 'https://mboprinters.com/en/product/mbo-uv2513',
    consumables: mboConsumablesI3200,
    accessories: [...mboAccessories, {
      id: 'vacuum-industrial',
      name: 'Mesa de Vacío Industrial',
  ...
  // ============ ARTISJET ============
  {
    ...
    specs: {
      ...
      inkType: 'UV LED CMYK + W',
      heads: '1',
      headType: 'Epson Plotter (6ch CMYK+W)',
      connectivity: 'USB 2.0',
      power: '100V-240V 50/60Hz',
      dimensions: '760 x 740 x 460 mm',
      weight: '60 kg',
    },
    manualUrl: 'https://boprint.net/producto/artis-young-uv-led/',
  ...
  },
  {
    ...
    brand: 'ARTISJET',
    name: 'artis 3000U Pro Freebird',
    fullName: 'artisJet 3000 PRO FREEBIRD',
    category: 'artisjet',
    image: artisjetA3000proImage,
    price: '13.900€',
    priceWithVat: '16.819€',
    specs: {
      printArea: '35 x 50 cm',
      maxHeight: '17 cm',
    ...
    manualUrl: 'https://boprint.net/contacto/',
  ...
  },
  {
    ...
    manualUrl: 'https://boprint.net/producto/5000-uv-led/',
    consumables: artisjetConsumables,
    accessories: artisjetAccessories,
  },
  {
    ...
    specs: {
      ...
      maxHeight: '17 cm',
      resolution: '720 x 2880 dpi',
      inkType: 'UV LED CMYK + WWWW + WW + VV (Barniz)',
      heads: '1',
      headType: 'Epson DX7 Piezoelectric',
      connectivity: 'USB 2.0',
      power: '100V-240V 50/60Hz',
      dimensions: '1260 x 1430 x 825 mm',
      weight: '250 kg',
    },
    manualUrl: 'https://boprint.net/producto/artisjet-6090-uv-led/',
    consumables: artisjetConsumables,
    accessories: [...artisjetAccessories, {
      id: 'vacuum-trust',
      name: 'Mesa de Vacío',
  ...
  },
  {
    ...
    brand: 'ARTISJET',
    name: 'artisJet Proud',
    fullName: 'artisJet Proud Card Printer',
    category: 'artisjet',
    image: 'https://artisjet-printers.eu/wp-content/uploads/2024/05/artisJet-proud-card-printer-left-side-view.jpeg',
    price: '21.500€',
    priceWithVat: '26.015€',
    specs: {
      printArea: 'CR80 / Large Cards',
      maxHeight: '2 cm',
      resolution: '720 x 2880 dpi',
      inkType: 'UV LED CMYK + W',
      heads: '1',
      ...
      connectivity: 'USB 2.0',
      power: '100V-240V 50/60Hz',
      dimensions: '650 x 500 x 400 mm',
      weight: '45 kg',
    },
    manualUrl: 'https://boprint.net/?post_type=product&p=3276',
    consumables: artisjetConsumables,
    accessories: artisjetAccessories.filter(a => a.id !== 'rotary-artisjet'),
  },
  ...
  {
    id: 'pimpam-casebox',
    brand: 'PIMPAM VENDING',
    name: 'PimPam CaseBox',
    fullName: 'PimPam CaseBox UV Vending',
    category: 'pimpam',
    image: '',
    price: 'Consultar',
    specs: {
      printArea: 'Phone Cases (TPU/Silicone/PC)',
      maxHeight: 'N/A',
      resolution: 'UV LED',
      inkType: 'UV LED CMYK + W',
      heads: '1',
      ...
      power: '220V AC 50/60Hz',
      dimensions: 'Vending Machine',
      weight: 'Consultar',
    },
    manualUrl: 'https://pimpam-vending.com',
    consumables: [],
    accessories: [],
  },
  {
    id: 'pimpam-whitelabel',
    brand: 'PIMPAM VENDING',
    name: 'PimPam White Label',
    fullName: 'PimPam White Label Vending',
    category: 'pimpam',
    image: '',
    price: 'Consultar',
    specs: {
...
export const getMboGranFormatoModels = () => printerModels.filter(m => m.category === 'mbo-granformato');
export const getPimpamModels = () => printerModels.filter(m => m.category === 'pimpam');
export const getDiscontinuedModels = () => printerModels.filter(m => m.category === 'discontinued');
export const getActiveModels = () => printerModels.filter(m => m.category !== 'discontinued');
